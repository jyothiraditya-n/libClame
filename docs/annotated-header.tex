...
You can use this libarry in your program by including the \mintinline{bash}{libClame.h} header file. As such, this reference document provides an annotated version of this header file as a guide to how you should set up your C code.
